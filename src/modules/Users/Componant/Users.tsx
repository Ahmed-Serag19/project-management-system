...
const filteredPages = arrayOfPages.filter(pageN => pageN >= 1 && pageN <= 10);

  let getAllUsers = async (pageS?:number,pageN?:number ,nameInput?: string, groupsInput?: any) => {
    try {
...
<div className="mx-5 mb-2 pt-1 rounded-2 bg-white">
{userList.length > 0 ? 
<div>
<div className="mb-3 ms-3 mt-4 pt-2 d-flex ">
          ...
          <div className=".col-md-2 ">
            <select
              ...
              className="  text-black border rounded-pill py-2 px-3  "
            >
              <option value="" >
                {" "}
                Filter
